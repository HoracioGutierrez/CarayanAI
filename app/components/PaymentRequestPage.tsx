...
function PaymentRequestPage() {
    return (
        <>
            ...
            <p>La cuenta gratuita creada en CarayanIA por default viene solo con 5 preguntas para hacer. Ojala te hayas divertido con la app!</p>
            <p>Por cuestiones administrativas no puedo dejarla libre porque GPT sale no gratis, sino de mil amores les dejaria usar a CarayanIA siempre que quieran.</p>
